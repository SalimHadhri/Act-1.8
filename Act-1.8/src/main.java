...
public class main {
	...
	public static void main(String[] args) {
		...
		Lion lion1 = new Lion(FacteurDomination.dominant, RangDomination.APLHA, 5,"masculin", Categorie.jeune , 5, GroupeorSolitraire.solitaire ,Nourriture.omnivore) ;
		lion1.seNourrir(); 
		lion1.chasser();
		...
		Lion lion2 = new Lion(FacteurDomination.nonDominant, RangDomination.BETA, 5,"masculin", Categorie.jeune , 5, GroupeorSolitraire.solitaire ,Nourriture.omnivore) ;
		Lion lion3 = new Lion(FacteurDomination.dominant, RangDomination.GAMA, 5,"masculin", Categorie.vieux , 5, GroupeorSolitraire.solitaire ,Nourriture.omnivore) ;
		Lion lion4 = new Lion(FacteurDomination.nonDominant, RangDomination.APLHA, 5,"masculin", Categorie.jeune , 5, GroupeorSolitraire.groupe ,Nourriture.omnivore) ;
		Lion lion5 = new Lion(FacteurDomination.dominant, RangDomination.OMEGA, 8,"masculin", Categorie.jeune , 5, GroupeorSolitraire.solitaire ,Nourriture.omnivore) ;
