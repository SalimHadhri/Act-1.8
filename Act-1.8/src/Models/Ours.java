...
public class Ours  extends Prédateur implements OursAction {
	...
	public Ours(int facteurAgressivite, float puissance, StatutHivernation statutHivernation,String sexe, Categorie categorie, int force, GroupeorSolitraire groupeorSolitraire,
